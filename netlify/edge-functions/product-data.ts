/**
 * Minimal product data for edge function OG meta injection.
 * Duplicated from src/data/products.ts for the Deno edge runtime.
 */
...
function makeImage(index: number): string {
...
const featuredProducts: ProductMeta[] = [
...
function generateProductName(id: string, collection: string, category: string): string {
...
function generateProducts(): ProductMeta[] {
  const generated: ProductMeta[] = []
...
const allProducts: ProductMeta[] = [...featuredProducts, ...generateProducts()]
const productMap = new Map(allProducts.map((p) => [p.id, p]))

export function getProductById(id: string): ProductMeta | undefined {
